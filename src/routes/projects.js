...
// @desc    Obținere proiecte în care utilizatorul este implicat
// @access  Private
router.get('/', authMiddleware, async (req, res) => {
  try {
    console.log('Getting projects for user:', req.user.id);
    
    // Găsește proiectele în care utilizatorul este creator sau membru
...
router.post('/', authMiddleware, async (req, res) => {
  try {
    const { title, description, startDate, endDate, status, targetSpecies } = req.body;
...
// @desc    Obținere proiect după ID (doar dacă utilizatorul are acces)
// @access  Private
router.get('/:id', authMiddleware, async (req, res) => {
  try {
    console.log('Getting project:', req.params.id, 'for user:', req.user.id);
